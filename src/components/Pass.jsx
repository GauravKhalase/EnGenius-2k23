      ...
      <div className="max-w-[80%] flex flex-col justify-center items-center mx-auto py-12">
        ...
        <div className="text-center pb-5">
          <div className="font-semibold">
            The Pass includes some benefits mentioned...
          </div>
          <div className="text-[15px]">
            1. Enjoy the event show with comfort and reserved seat for oneself.
          </div>
          <div className="text-[15px]">
            2. Snacks will be provided during the break.
          </div>
        </div>
        <div className="text-center  pb-5">
          This PASS costs you only <span className="font-semibold">30/-</span>{" "}
          per head for entire Event
        </div>
        <div className="text-red-500 font-bold text-xl uppercase pb-5">
          Sorry!{" "}
          <span className="text-[15px] font-semibold text-black">
            you are late.
          </span>
        </div>
        <div className="text-center font-semibold pb-6">
          All seats are fully booked for EnGenius-2023.
        </div>

        <div className=" text-center  ">
          <img className="w-[100px] mx-auto pb-5" src={warning} alt="" />
          <div span className="text-red-500 font-bold text-xl uppercase pb-4">
            Attention Please
          </div>
        ...
        <div className="text-center">
          <span className="font-bold">NOTE : </span>Keep your entry pass with
          you for venue entry.
        </div>
      </div>
    </div>
